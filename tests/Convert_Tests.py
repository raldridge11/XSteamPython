...
class Test_Conversions(unittest.TestCase):
    ...
    def test_toSIUnit_entropy_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'entropy'), 1.0/0.238845896627)

    def test_fromSIUnit_entropy_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'entropy'), 0.238845896627)

    def test_toSIUnit_enthalpy_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'enthalpy'), 2.326)

    def test_fromSIUnit_enthalpy_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'enthalpy'), 1.0/2.326)

    def test_toSIUnit_specificVolume_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'specific volume'), 0.0624279606)

    def test_fromSIUnit_specificVolume_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'specific volume'), 1.0/0.0624279606)

    def test_toSIUnit_velocity_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'velocity'), 0.3048)

    def test_fromSIUnit_velocity_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'velocity'), 1.0/0.3048)

    def test_toSIUnit_thermalConductivity_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'thermal conductivity'), 1.0/0.577789)

    def test_fromSIUnit_thermalConductivity_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'thermal conductivity'), 0.577789)

    def test_toSIUnit_surfaceTension_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'surface tension'), 1.0/0.068521766)

    def test_fromSIUnit_surfaceTension_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'surface tension'), 0.068521766)

    def test_toSIUnit_dynamicViscosity_English(self):
        self.assertEqual(Convert.toSIUnit(1.0, 'viscosity'), 1.0/2419.088311)

    def test_fromSIUnit_dynamicViscosity_English(self):
        self.assertEqual(Convert.fromSIUnit(1.0, 'viscosity'), 2419.088311)
